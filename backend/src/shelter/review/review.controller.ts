...
export class ReviewController {
  ...
  async getReviews(@Param('shelterId') shelterId: string) {
    const reviews = (await this.shelterService.getShelterById(shelterId))
      .reviews;
    return reviews;
  }
  /**
  ...
  async getReviewById(
    ...
    const review = await this.shelterService.getShelterReviewById(
      shelterId,
      reviewer,
    );
    if (review == undefined) {
  ...
  async addReview(
    ...
    await this.shelterService.addShelterReview(
      shelterId,
      reviewer,
      content,
      rating,
  ...
  async editReview(
    ...
    await this.shelterService.editShelterReview(
      shelterId,
      reviewerId,
      content,
      rating,
