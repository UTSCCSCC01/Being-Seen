...
Your Mark: 2 need to name all your participants so we know everyone was there
...
## Daily Stand-ups (max 10 marks)
  ...
  Daily Stand-ups Total Mark: 9 / 10 Lianting didn't submit his first standup document on time
...
## User Stories (Tracked in Jira) (max 10 marks) 
  ...
  - Clearly Defined Acceptance Criteria (max 2 marks)
    ...
    Your Mark: 1 BRUT-30 missing acceptance criteria
...
## Tracking on Jira  (max 20 marks) 
  ...
  - Did you start all stories for sprint one? (max 2 marks)
    ...
    Your Mark: 1 BRUT-17 not started, no explanation why
  ...
  - Do the pull request on GitHub match the tasks listed on Jira Active Sprint Board? (max 2 marks)
    ...
    Your Mark: 1 missing 34, 35, 36, among others
...
Your Mark: 0 there should be far more PRs with the different task titles, instead of only BRUT 63, 8, 61, 32, 30 and 27 showing up since you have so many tasks
...
Tracking on Jira Total Mark: 11 / 20
