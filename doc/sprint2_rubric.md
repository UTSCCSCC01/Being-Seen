...
UI looks better, but some comments from last time still hold (margins needed so text isn't right up against borders)

Unclear that clicking on reviews will lead you to edit/delete page

Phone number not aligned with rest of lines
