...
**Github:** https://github.com/UTSCCSCC01/projectf21-brute-forced-solutions  
...
## Definition of done: done.md (max 2 marks)
  ...
  Feedback: The definition of done is a bit too broad. Focused more on your end product feature rather than the user stories you are accomplishing.
...
## Personas.pdf (max 8 marks)
  ...
  - Quality of the persona should be measured based on the presence/absence quality of description of the following elements:
    ...
    - 0 marks = No personas provided
	  ...
	  Your mark: 3
    Feedback: 3 personas provided however missing a few key details about the user such as skills and goals when using the system. For two of the personas, you mentioned what they expect to get out of the app but not necessarily the goals
...
## Process: process.md (max 10 marks)
  - Team organization (roles) divided clearly (max 2 marks)
    ...
    Your mark: 1   
    Feedback: Not clear on team roles. Did not specify how the work is divided.
  ...
  - Prioritizing user stories (max 2 marks)
    ...
    Your mark: 0
    Feedback: No information on user story prioritization
  ...
  - Meetings (max 2 marks)
    ...
    Your mark: 1
    Feedback: Although the group mentions they plan to meet once every day, there is no plan that was specificially mentioned. It is more reflection based than an actual plan.
